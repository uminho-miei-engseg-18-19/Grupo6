...
class Blockchain{
    ...
    createGenesisBlock(){
	var d = new Date()
        return new Block(0,d , "Bloco inicial da koreCoin", "0");
    }
...
koreCoin.addBlock(new Block (4, "02/01/2018", [{from:"p1", to:"p2", amount: 500}]));
koreCoin.addBlock(new Block (5, "02/01/2018", [{from:"p2", to:"p3", amount: 60}]));
koreCoin.addBlock(new Block (6, "02/01/2018", [{from:"p3", to:"p4", amount: 30}]));
